...
# ///
"""Resolve LCH's four central TOML layers to JSON."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Resolve LCH central config using four-layer TOML merge."
    )
    parser.add_argument(
        "--project-root",
        "-p",
        required=True,
        help="Absolute project root containing _lch/",
    )
    parser.add_argument(
        "--key",
        "-k",
