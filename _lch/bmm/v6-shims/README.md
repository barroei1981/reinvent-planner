...
| Shim                       | Forwards to                          |
| -------------------------- | ------------------------------------ |
| `lch-quick-dev`           | `lch-build`                         |
| `lch-dev-auto`            | `lch-build-auto`                    |
| `lch-create-story`        | Retained in full                     |
| `lch-dev-story`           | Retained in full                     |
| `lch-create-prd`          | `lch-prd` (create intent)           |
| `lch-edit-prd`            | `lch-prd` (update intent)           |
| `lch-validate-prd`        | `lch-prd` (validate intent)         |
| `lch-create-architecture` | `lch-architecture` (create intent)  |
| `lch-market-research`     | `lch-deep-recon` (market type)      |
| `lch-domain-research`     | `lch-deep-recon` (domain type)      |
| `lch-technical-research`  | `lch-deep-recon` (technical type)   |
| `lch-sprint-status`       | `lch-sprint-planning` (status view) |
